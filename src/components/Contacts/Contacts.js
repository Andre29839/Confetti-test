...
import svgCall from "@/assets/call.svg";
import svgSms from "@/assets/sms.svg";
  ...
  return (
    <ContactSectionMain id="contacts">
      <ContactSection>
        ...
        <ContactSubTitle>
          Confetti - Studio<span> Dekoracij Balonami</span> Warszawa
        </ContactSubTitle>
        <ContactContainerInformationMain>
          <ContactContainerInformation>
            ...
            <ContactContainerData href="tel:+48793351407">
              +48 793 351 407
            </ContactContainerData>
          </ContactContainerInformation>
          <ContactContainerInformation>
            ...
            <ContactContainerData href="mailto:confettibalony@gmail.com">
